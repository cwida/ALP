...
#include "datablock/schemes/v1/templated/VarDictionary.hpp"
// -------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------
u32 Dictionary8::compress(const StringArrayViewer src, const BITMAP *nullmap, u8 *dest, StringStats &stats)
{
...
// -------------------------------------------------------------------------------------
void Dictionary8::decompress(u8 *dest, BitmapWrapper *nullmap, const u8 *src, u32 tuple_count, u32 level)
{
...
// -------------------------------------------------------------------------------------
u32 Dictionary16::compress(const StringArrayViewer src, const BITMAP *nullmap, u8 *dest, StringStats &stats)
{
...
// -------------------------------------------------------------------------------------
void Dictionary16::decompress(u8 *dest, BitmapWrapper *nullmap, const u8 *src, u32 tuple_count, u32 level)
{
