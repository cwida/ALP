...
static bool test_compression(std::vector<INTEGER> &src, cengine::db::IntegerScheme &scheme) {
    ...
    cengine::db::SInteger32Stats stats(src_ptr, nullptr, src.size());
...
int main(void) {
    ...
    cengine::db::v2::integer::PBP pbp;
    result = test_compression(src, pbp);
    assert(result);

    cengine::db::v2::integer::FBP fbp;
