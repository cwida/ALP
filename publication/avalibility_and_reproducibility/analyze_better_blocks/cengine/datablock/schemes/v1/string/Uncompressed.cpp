...
{
   return 1.0;
   //return static_cast<double>(stats.total_length) / static_cast<double>(stats.total_length + sizeof(u32));// actually it is just 1 !
}
// -------------------------------------------------------------------------------------
u32 Uncompressed::compress(const StringArrayViewer src, const BITMAP *, u8 *dest, StringStats &stats)
{
...
// -------------------------------------------------------------------------------------
void Uncompressed::decompress(u8 *dest, BitmapWrapper *nullmap, const u8 *src, u32 tuple_count, u32 level)
{
