#include "x86_64_avx512bw_intrinsic_1024_uf1_falp_bench_bw.hpp"
#include "alp.hpp"
#include "data.hpp"
...
void benchmark_all(benchmark::Benchmark& benchmark) {
	...
	for (auto& dataset : alp_bench::get_generated_cols()) {
...
int main() {
	benchmark::Benchmark benchmark =
	    benchmark::create("x86_64_avx512bw_intrinsic_1024_uf1_falp_bw")
	        .save()
