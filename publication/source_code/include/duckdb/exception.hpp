...
#include "assert.hpp"
#include "common.hpp"
#include "exception_format_value.hpp"
#include "vector.hpp"
#include <stdexcept>
...
inline void assert_restrict_function(
    void* left_start, void* left_end, void* right_start, void* right_end, const char* fname, int linenr) {
...
public:
	...
	static string
	ConstructMessageRecursive(const string& msg, vector<ExceptionFormatValue>& values, T param, Args... params) {
