...
public:
    ...
    // Only the whole decompressed data without the btr specific metadata around it.
    ...
    [[nodiscard]] inline ColumnType getColumnType() {
        return this->getChunkMetadata(0)->type;
    }
    [[nodiscard]] inline u32 getChunkCount() {
        return this->getPartMetadata()->num_chunks;
    }
private:
    void *data{};
