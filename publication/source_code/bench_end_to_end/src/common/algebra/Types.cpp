...
Double::operator std::string() const { return "Integer"; }
size_t Double::rt_size() const { return sizeof(types::Double); };
const std::string& Double::cppname() const {
   static std::string cppname = "Double";
   return cppname;
}
