...
public:
	...
	runtime::Vector<uint8_t*> data_0_;
	runtime::Vector<uint8_t*> data_1_;
	runtime::Vector<uint8_t*> data_2_;
	runtime::Vector<uint8_t*> data_3_;
	runtime::Vector<uint8_t*> data_4_;

	runtime::Vector<uint8_t>& access_0() { return reinterpret_cast<runtime::Vector<uint8_t>&>(data_0_); }
	runtime::Vector<uint8_t>& access_1() { return reinterpret_cast<runtime::Vector<uint8_t>&>(data_1_); }
	runtime::Vector<uint8_t>& access_2() { return reinterpret_cast<runtime::Vector<uint8_t>&>(data_2_); }
	runtime::Vector<uint8_t>& access_3() { return reinterpret_cast<runtime::Vector<uint8_t>&>(data_3_); }
	runtime::Vector<uint8_t>& access_4() { return reinterpret_cast<runtime::Vector<uint8_t>&>(data_4_); }

	void* data(int sub_c) {
		switch (sub_c) {
		case 0:
			return data_0_.alp_data();

		case 1:
			return data_1_.alp_data();

		case 2:
			return data_2_.alp_data();

		case 3:
			return data_3_.alp_data();
		case 4:
			return data_4_.alp_data();
		}
	}
};
