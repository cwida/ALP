...
public:
	...
	OpArgs(pos_t(f)(pos_t, Args...), Args... x)
	    : function(f)
	    , args(x...) {}
...
struct GatherOpVal : public Op {
	...
	size_t*                struct_size;
	void*                  target;
	GatherOpVal(primitives::FGatherVal op, void** source, size_t off, size_t* struct_size, void* target);
	virtual pos_t run(pos_t n) override;
};
...
struct EqualityCheck : public Op {
	...
	pos_t*              probeIdxs;
	void*               probeData;
	EqualityCheck(primitives::EQCheck p, void** ptrs, size_t off, pos_t* probeIdxs, void* probeData);
...
struct NEqualityCheck : public Op {
	...
	NEqualityCheck(primitives::NEQCheck eq,
	               pos_t*               entryIdx,
	               void**               entry,
	               void*                probeKey,
	               size_t               offset,
...
struct NEqualityCheckSel : public Op {
	...
	size_t                  offset;
	SizeBuffer<pos_t>*      notEq;
	NEqualityCheckSel(primitives::NEQCheckSel eq,
	                  pos_t*                  entryIdx,
	                  void**                  entry,
	                  pos_t*                  probes,
	                  void*                   probeKey,
...
/// selection with input select and two params
{
	...
	primitives::F5 operation;
	F5_Op(void* data_0, void* data_1, void* data_2, void* data_3, void* data_4, primitives::F5 o)
	    : data_0(data_0)
	    , data_1(data_1)
	    , data_2(data_2)
	    , data_3(data_3)
...
struct F6_Op : public Op {
	...
	primitives::F6 operation;
	F6_Op(void* data_0, void* data_1, void* data_2, void* data_3, void* data_4, void* data_5, primitives::F6 o)
	    : data_0(data_0)
	    , data_1(data_1)
	    , data_2(data_2)
	    , data_3(data_3)
