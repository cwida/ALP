...
//      u32 used_space;
//      IntegerSchemePicker::compress(biased_output.data(), nullmap, write_ptr, biased_output.size(), allowed_cascading_level - 1, used_space, col_struct.next_scheme);
...
//   // -------------------------------------------------------------------------------------
//   static inline
//   void decompressColumn(NumberType *dest, BITMAP *, const u8 *src, u32 tuple_count)
//   {
//
//   }
//}
