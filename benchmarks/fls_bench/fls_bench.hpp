...
/*
 * The M1 cycle counter is from Lemire repo.
 * https://github.com/lemire/Code-used-on-Daniel-Lemire-s-blog/tree/master/2021/03/24 The other parts are from google
 * benchmark repo, edited heavily. todo -> add the link
 */
#include <algorithm>
#include <array>
#include <bitset>
...
#elif defined BENCHMARK_HAS_SYSCTL && !defined BENCHMARK_OS_MACOSX // disable SYSCTL on macos as well for now. todo enable this
